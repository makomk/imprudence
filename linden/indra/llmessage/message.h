...
public: // was private, made public for use of message builder
...
public:	// HACK for llfloatermessagebuilder.cpp, was private
...
public:
	// HACK for use of llfloatermessagebuilder.cpp
	LLCircuit* getCircuit() { return &mCircuitInfo; }
};
